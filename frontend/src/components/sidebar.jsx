...
import { FaCog, FaBars, FaTimes } from 'react-icons/fa'; // Import additional icons
...
export default function Sidebar({ selectedOllamaServer, setSelectedOllamaServer, setIsModalOpen, selectedModel, setSelectedModel }) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <section className={`${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:static inset-y-0 left-0 z-40 w-64 md:w-auto transition-transform duration-300 ease-in-out flex flex-col gap-5 p-5 border-green-500 border-r bg-black min-w-[250px] md:min-w-[300px]`}>
                ...
                <div className="flex flex-col gap-5 flex-1 min-h-0 overflow-y-auto">
                    ...
                    <div className="flex flex-col">
                        ...
                        <NavLink to={'/email-scheduler'} end className={({ isActive }) => isActive ?
                            "text-green-500 font-bold text-xl  drop-shadow-green-600 drop-shadow-md border-green-500 border  hover:border p-2"
                            : "text-green-700 hover:text-green-500 font-bold   drop-shadow-green-600 drop-shadow-md border-green-500 hover:border p-2"}>
                            Automated Reports
                        </NavLink>
